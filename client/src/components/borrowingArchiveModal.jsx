...
class ArchiveBorrowingModal extends Component {
	constructor(props) {
		super(props);
			...
			<React.Fragment>
				<Button variant={this.props.design} onClick={this.handleShow}>
                    ...
                    <Modal.Header closeButton>
                        <Modal.Title>Archive Record</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <p>Do you wish to archive this record?</p>
                    </Modal.Body>
                    <Modal.Footer>
...
export default ArchiveBorrowingModal;